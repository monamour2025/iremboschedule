import { examCentersMatch, isSystemExamCenter, KICUKIRO_BUSANZA_SITE, normalizeCenterName, SYSTEM_EXAM_CENTER, SYSTEM_EXAM_LOCATION } from "./examCenters.js";
import { isOpenUpcomingSchedule } from "./scheduleTime.js";

const CENTER_EXPECTED_LOCATIONS = {
  [KICUKIRO_BUSANZA_SITE.toLowerCase()]: "kicukiro",
  [SYSTEM_EXAM_CENTER.toLowerCase()]: "kicukiro"
};
...
export function resolveScheduleLocation(center, fallbackLocation = "") {
  ...
  if (name === SYSTEM_EXAM_CENTER.toLowerCase()) {
    return "Kicukiro";
  }
